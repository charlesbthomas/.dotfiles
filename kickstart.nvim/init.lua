...
vim.keymap.set('n', '<leader>ae', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' })
vim.keymap.set('n', '<leader>fm', vim.lsp.buf.format, { desc = 'Manually format current buffer' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fn', function()
        builtin.diagnostics { severity = 'WARN' }
      end, { desc = '[S]earch Diagnostics Warni[N]gs' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gD', vim.lsp.buf.definition, '[G]oto [D]efitition')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        -- If java file is opened, don't format on save
        if vim.bo.filetype == 'java' then
          return
        end

        -- If the global variable is set, or the buffer-local variable is set, don't format on save
